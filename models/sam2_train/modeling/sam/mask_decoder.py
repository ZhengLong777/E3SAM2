...
from models.sam2_train.modeling.sam2_utils import LayerNorm2d, MLP
...
class MaskDecoder(nn.Module):
    ...
    def predict_masks(
        ...
        if sparse_prompt_embeddings is not None:
            ...
            # tokens = output_tokens.unsqueeze(0) # 修改前
            tokens = output_tokens.unsqueeze(0).expand(dense_prompt_embeddings.size(0), -1, -1)   # 修改后 b,5,256
